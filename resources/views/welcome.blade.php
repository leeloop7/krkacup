...
<section id="home" class="flex items-center justify-center min-h-screen text-white bg-gradient-to-r from-green-500 to-blue-500 font-barlow">
    <div class="text-center">
        <h1 class="mb-4 text-6xl font-extrabold">Krka Cup 2025</h1>
...
<footer class="fixed bottom-0 w-full p-4 text-center text-white bg-gray-800">
    &copy; 2025 Tournament Site
</footer>
